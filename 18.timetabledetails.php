...
<div class="content-body">
        ...
        <div class="col-md-8">
            <table class="table">
                <tr>
                    ...
                    <td>
                        <input type="radio" name="" id=""> <b>Teacher-Wise</b>
                    </td>
                    <td>
                        <input type="radio" name="" id=""> <b>Subject-Wise</b>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row">
        <div class="col-md-9">
            <p>Timetable Details <i class="fa fa-plus-circle" aria-hidden="true"></i></p>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                ...
                <tr>
                    ...
                    <td>Prayer Hour</td>
                    <td>Prayer Hour</td>
                    <td style="text-align: center;"><i class="fas fa-edit"></i><i class="fa fa-trash" style="padding-left: 5px;" aria-hidden="true"></i></td>
                </tr>
            </table>
        </div>
