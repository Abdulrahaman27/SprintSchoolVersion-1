...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row mx-auto pb-4">
            <div class="col-md-2">
                <a href="46.home.php"><img src="public/assets/images/home.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Home</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="47.campussetup.php"><img src="public/assets/images/university_campus.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Campus Setup</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="48.academicsetup.php"><img src="public/assets/images/flying_mortarboard.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Academic Setup</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="49.campusmaster"><img src="public/assets/images/hostel.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Campus Master</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="50.adminmodule"><img src="public/assets/images/administrative_tools.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Admin Module</h5>
                </a>
            </div>
        </div>
        <div class="row mx-auto pb-4">
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/user_engagement_male.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">User Management</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/family.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">HR Management</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/account.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Account Management</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/student_male.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Campus Operation</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/course_assign.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Academics</h5>
                </a>
            </div>
        </div>
        <div class="row mx-auto pb-4">
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/library.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Library</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/hostel1.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Dormitory</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/public_transportation.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Transportation</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/history_book.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Academic History</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href=""><img src="public/assets/images/management.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Lead Management System</h5>
                </a>
            </div>
        </div>
        <div class="row">
