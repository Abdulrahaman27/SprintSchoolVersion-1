...
<div class="content-body">
    <div class="row text-center tbl-bordered" style="font-size: 12px;">
        <div class="col-md-8">
            <table class="table table-bordered table-inverse table-responsive" style="border: 1px solid black;">
                <tbody>
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="38.achievement.php">Achievements</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="39.experience.php">Experience</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="40.familydetails.php">Family Details</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="41.leavesummary.php">Leave Summary</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="42.profile.php">Profile</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="43.qualification.php">qualification</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="44.review&appraisal.php">Review & Appraisal</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="row mx-auto tbl-bordered">

        <div class="col-md-4 m-1 p-1" style="border: 1px solid #ddd;">
        ...
        <div class="col-md-3 m-1 p-1" style="border: 1px solid #ddd;">
            <table class="table table-bordered table-inverse table-responsive mx-auto" style="width: 80%;">
                <tr>
                    <td>Aadhar No : </td>
                    <td><input type="text" class="form-control" name="" id=""></td>
                </tr>
        ...
        <div class="col-md-4" style="border: 1px solid #ddd;">
            ...
            <textarea name="" id="" cols="3" style="width: 100%;border: 1px solid #ddd;" rows="3"></textarea>
        </div>

        <div class="row mt-3 mb-3">
            <div class="col-md-12">
                <span style="padding-right: 15px;">Dorm Facility<input type="checkbox"></span>
                <span style="padding-right: 15px;">Down Facility?<input type="checkbox"></span>
                <span>Physically Challenge<input type="checkbox"></span>
            </div>
        </div>

        <div class="row">
            <div class="col-md-12 pt-1 pr-2 pb-1 pl-1" style="border: 1px solid #ddd;">
                <p><b>About me</b></p>
                <textarea name="" id="" cols="2" rows="3" style="width: 80%;border: 1px solid #ddd;"></textarea>
        ...
        <div class="row mt-2">
            <b>Notes</b>
            <textarea name="" id="" style="border: 1px solid #ddd;" cols="2" rows="3"></textarea>
        </div>
    </div>
</div>
<!--**********************************
