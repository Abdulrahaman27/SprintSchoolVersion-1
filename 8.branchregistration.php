...
<div class="content-body">
    ...
    <div class="container-fluid p-0">
        <div class="row" style="font-size: 12px;">
            <div class="col-md-4">
                <table class="table table-bordered table-inverse table-responsive" style="border:1px solid black">
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href=" 7.instituteregistration.php">Institute Information</a></td>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href=" 8.branchregistration.php">Branch Registration</a></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
        <div class="row">
            <div class="col-md-6">
                <table class="table">
                    <tr>
    ...
    <div class="row branchregistration">
        <div class="col-md-12">
            <p>Add new <i class="fa fa-plus-circle" aria-hidden="true"></i></p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td class="text-center">*Year Establishment : </td>
                            <td>
                                <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="text-center">Branch Alias : </td>
                            <td>
                                <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">Institution Type: </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">*Inst Category: </td>
                            <td>
                                <label for=""></label>
                                <select class="form-control" name="" id="">
                                    <option value="select">Select</option>
                        ...
                        <tr>
                            <td class="text-center">Alternate Email : </td>
                            <td><input type="text" class="form-control"></td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="col-md-3">
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    ...
                    <tr>
                        <td class="text-center">Office No : </td>
                        <td>
                            <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                    ...
                    <tr>
                        <td class="text-center">*Country TimeZone : </td>
                        <td>
                            <label for=""></label>
                            <select class="form-control" name="" id="">
                                <option value="select">Select</option>
                    ...
                    <tr>
                        <td colspan="2" class="text-left">* Pick Your Address <i class="fa fa-location-arrow" aria-hidden="true"></i>: <br />
                            <div class="form-group">
                                <label for=""></label>
                                <textarea name="" id="" class="form-control" cols="2" rows="3"></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr class="text-center">
                        <td class="text-center">AdmNo prefix: </td>
                        <td>
                            <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center">AdmNo Prefix Padding: </td>
                        <td>
                            <label for=""></label>
                            <select class="form-control" name="" id="">
                                <option value="select">Select</option>
        ...
        <div class="col-md-3">
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tr>
                        <td class="text-center">Smtp Port Url:</td>
                        <td><input type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td class="text-center">Port No:</td>
                        <td><input type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td class="text-center">Email:</td>
        ...
        <div class="col-md-3">
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <p class="mb-0"><b>Branch Logo</b></p>
                <div class="form-group">
                    <label for=""></label>
                    <input type="file" class="form-control" name="" id="" aria-describedby="helpId" value="Upload Branch Logo">
                </div>

                <div style="width:50%;height:100px;border:1px solid #ddd;">
                </div>
                ...
                <table class="table table-striped table-inverse table-responsive">
                    ...
                    <tbody>
                        <tr>
                            <td class="bg-white">
                                <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="File Description">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="form-group">
                    <input type="button" class="form-control" name="" id="" aria-describedby="helpId" value="Upload Documents">
                </div>
    ...
    <div class="row branchregistration">
        <div class="col-md-9">
            <table class="table table-inverse table-bordered table-responsive">
                <tr class="bg-light">
                    <th>Days</th>
                    <th>Sunday</th>
                    <th>Monday</th>
                ...
                <tr>
                    <td>*Working Days <input type="checkbox" name="" id=""></td>
            ...
            <table>
                <tr>
                    <td>
                        <div class="form-group">
                            <label for=""></label>
                            <input type="submit" class="form-control" name="" id="" aria-describedby="helpId" value="Save">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <label for=""></label>
                            <input type="submit" class="form-control" name="" id="" aria-describedby="helpId" value="Clear">
                        </div>
                    </td>
                </tr>
            </table>
