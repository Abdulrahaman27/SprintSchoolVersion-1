...
<div class="content-body">
    <div class="row" style="font-size: 10px;">
        <div class="col-md-5">
            <table class="table table-bordered table-inverse table-responsive" style="border:1px solid black">
                <tr>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="21.finalmarks.php">Final Marks</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="22.academicchecks.php">Academic Checks</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="23.studentpromotion.php">Student Promotion</a></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6" style="border: 1px solid #ddd;margin-left: 10px;padding: 6px;">
            <div class="row">
                <div class="col-md-4">Academic Checks</div>
                <div class="col-md-4">*Curriculum Code : </div>
                <div class="col-md-4">
                    <select class="form-control " name="select" id="">
                        <option value="select">select</option>
                        <option value="select">select</option>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-inverse table-responsive">
                        ...
                        <tr>
                            ...
                            <td><input type="button" class="p-1" value="Generate"></td>
                            <td class="text-center"><input checked type="checkbox" name="" id=""></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Campus Calendar</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> <button type="button" class="btn btn-square btn-outline-light">Generate Above All Steps</button></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-5" style="border: 1px solid #ddd;margin-left: 30px;">
            <div class="row" style="padding-top: 20px;">
                <div class="col-md-6">
                    <p style="font-weight: 600;">Year End Curriculum Promotions</p>
                </div>
                <div class="col-md-6 text-end"><i class="fa fa-search" aria-hidden="true"></i></div>
            </div>
            <div class="tbl-bordered">
                <table class="table table-bordered table-inverse table-responsive">
                    ...
                    <tr>
                        ...
                        <td><input type="button" value="Promote" style="padding: 2px 5px;"></td>
                        <td class="text-center"><i class=" fa fa-crop" aria-hidden="true"></i></td>
                    </tr>
                    <tr class="bg-dark text-black">
                        <td colspan="4" class="text-center" style="font-weight: bold;font-style: italic;">
                            Promote Status of All
                            Curriculum</td>
                    </tr>
                </table>
            </div>
