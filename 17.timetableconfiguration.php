...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-4">
            <p>Class Period Time Table <i class="fa fa-plus-circle" aria-hidden="true"></i></p>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-3 mx-auto">
            <div class="">
                ...
                <button type="button" class="btn btn-square btn-outline-light">Generate Time Table</button>
                <button type="button" class="btn btn-square btn-outline-light">Edit</button>
            </div>
        </div>
    </div>
