...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-6">Building Management <i class="fa fa-plus-circle" aria-hidden="true"></i></div>
        <div class="col-md-6 text-end"><i class="fas fa-search-location"></i></div>
    </div>
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                ...
                <tr>
                    ...
                    <td>comment</td>
                    <td><span style="padding-right: 12px;"><i class="fas fa-pen"></i></span><i class="fa fa-address-book" aria-hidden="true"></i></td>
                </tr>
                <tr>
                    <td>A1</td>
                    <td>1</td>
