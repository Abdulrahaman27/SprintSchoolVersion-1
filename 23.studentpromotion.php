...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-7" style="font-weight: bold;">Current Academic Year</div>
        <div class="col-md-5" style="font-weight: bold;">Next Academic Year</div>
    </div>

    <div class="row">
        <div class="col-md-5" style="border: 1px solid #ddd;">
            <div class="row" style="margin-top: 15px;">
                <div class="col-md-4" style=" font-size: 10px;">*Curriculum Code : <select class="form-control " name="select" id="">
                        <option value="select">select</option>
                        <option value="select">select</option>
                        <option value="select">select</option>
                    </select>
                </div>
                <div class="col-md-4" style=" font-size: 10px;">*Class<select class="form-control " name="select" id="">
                        <option value="select">select</option>
                        <option value="select">select</option>
                        <option value="select">select</option>
                    </select>
                </div>
                <div class="col-md-4" style=" font-size: 10px;">*Section<select class="form-control" name="select" id="">
                        <option value="select">select</option>
                        <option value="select">select</option>
                        <option value="select">select</option>
                    </select>
            ...
            <div class="row" style="margin-top: 15px;margin-bottom: 5px;">
                <div class="col-md-12">
                    <input type="radio" name="" id=""> Eligible
                    <input type="radio" name="" id=""> Not Eligible
                    <input type="radio" checked name="" id=""> All
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-inverse table-responsive">
                        <tr class="bg-light">
                            ...
                            <th>Class</th>
                            <th>Section</th>
                            <th style="text-align: center;">Select<br /><input type="checkbox" name="" id="">
                            </th>
                        </tr>
                        <tr>
                            <td colspan="3">
            ...
            <div class="tbl-bordered">
                <table class="table table-bordered table-inverse table-responsive">
                    ...
                    <tr>
                        ...
                        <td>Bala Reddy</td>
                        <td>First</td>
                        <td class="text-center">CBSE_1A</td>
