...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-6"><b>Card design</b></div>
        <div class="col-md-6"><b>Card Management</b></div>
    </div>
    ...
    <div class="row">
        <div class="col-md-5" style="border: 1px solid #ddd;padding: 20px;">
            <table class="table table-bordered  table-responsive">
                ...
                <tr>
                    <td><b> * ID Card Theme</b>
                        <span style="border: 1px solid #ddd;padding: 5px;"><input type="file" name="" id=""></span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <b> * Select Text Color</b><br />
                        <span style="border: 1px solid #ddd;;"><input type="color" name="" id=""></span>
                    </td>
                </tr>
                <tr>
                    <td> <span style="padding-right: 5px;padding-left: 10px;"><input type="radio" name="" checked id=""> Potrait</span>
                        <span><input type="radio" name="" id=""> Landscaped</span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <b> *Template</b>
                        <select class="form-control" name="Select" id="">
                            <option value="select">Template1</option>
                            <option value="select">Select</option>
                            <option value="select">Select</option>
                        </select>
                    </td>
