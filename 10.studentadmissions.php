        ...
        <div class="row" style="font-size: 12px;">
            <div class="col-md-4">
                <table class="table table-bordered table-inverse table-responsive" style="border:1px solid black">
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="9.adminregistration.php">Admin Registration</a></td>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="10.studentadmissions.php">Student Admissions</a></td>
                    </tr>
                </table>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="file" class="form-control" name="" id="" aria-describedby="helpId" placeholder="File description">
                                </div>
                            </td>
                        </tr>
                    </tbody>
