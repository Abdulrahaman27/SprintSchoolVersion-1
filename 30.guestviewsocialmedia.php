...
<div class="content-body">
    <div class="row text-center" style="font-size: 12px;">
        <div class="col-md-6">
            <table class="table table-striped table-bordered table-inverse table-responsive" style="border: 1px solid black;">
                <tbody>
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="28.loaddata.php">Load
                                Data</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="29.guestview.php">Guest View</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="30.guestviewsocialmedia.php">Guest View Social Media</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="31.idcard.php">Id
                                Card</a></td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="row tbl-bordered">
        <div class="col-md-5" style="border: 1px solid #ddd;padding: 20px;">
            <b>Social Media Links</b>
            <table class="table bg-light table-bordered table-inverse table-responsive">
                <tr>
                    <td>Website Links : </td>
                    <td><input class="form-control p-1" type="text" name="" value="https://www.edusys.co/EducSysdemo/guest/index#/1044" id=""></td>
                </tr>
                <tr>
                    <td>* Facebook Links : </td>
                    <td><input class="form-control p-1" type="text" name="" value="https://www.facebook.com/" id=""></td>
                </tr>
                <tr>
                    <td>* Google+ Links : </td>
                    <td><input class=" form-control p-1" type="text" name="" value="https://www.googleplus.com" id=""></td>
                </tr>
                <tr>
                    <td><b>* Google+ Links : </b></td>
                    <td><input class=" form-control p-1" type="text" name="" value="https://www.twitter.com" id=""></td>
                </tr>
                <tr>
                    <td><b>* Pinterest Link : </b></td>
                    <td><input class=" form-control p-1" type="text" name="" value="https://www.pinterest.com" id=""></td>
                </tr>
                <tr>
                    <td><b>* Tumblr Link : </b></td>
                    <td><input class=" form-control p-1" type="text" name="" value="https://www.tumblr.com" id=""></td>
                </tr>
                <tr>
                    <td><b>* Youtube Link : </b></td>
                    <td><input class=" form-control p-1" type="text" name="" value="https://www.youtube.com" id=""></td>
                </tr>
                <tr>
                    <td><b>Website Theme : </b></td>
                    <td></td>
                </tr>
                <tr>
                    <td><b>Your Brochure : </b></td>
                    <td><span><input type="file" name="" id=""></span><br />1044_64472727476472.png</td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <button type="button" class="btn btn-square btn-outline-light">Save</button>
                        <button type="button" class="btn btn-square btn-outline-light">Clear</button>
                    </td>
                </tr>
            </table>
        </div>
        <div class="col-md-7 tbl-bordered">
            <b>Scrolling News/Updates Details <i class="fa fa-plus-circle" aria-hidden="true"></i></b>
            <table class="table table-bordered table-inverse  table-responsive">
                <tr class="bg-light">
                    <th>S No.</th>
                    <th>* News / U[dates Description</th>
                    <th class="text-center">Action</th>
                </tr>
                <tr>
                    <td>1</td>
                    <td>SPLASH 2018: AM ARTISTIC FORUM FOR EXPRESSION</td>
