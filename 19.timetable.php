...
<div class="content-body">
    <div class="row" style="font-size: 10px;">
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive" style="border:1px solid black">
                <tr>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="11.academicsetup.php">Academic year</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="12.subjectmanagement.php">Subject Management</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="13.sectionmanagement.php">Section Management</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="14.studenttosection.php">Student to Section</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="15.teachertosubject.php">Teacher to Subject</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="16.campuscalendar.php">Campus Calendar</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="17.timetableconfiguration.php">Timetable Configuration</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="18.timetabledetails.php">Timetable Details</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="19.timetable.php">Timetable</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="20.courseschedule.php">Course Schedule</a></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="col-md-12">
            <table class="table">
                <tr>
                    ...
                    <td>
                        <input type="radio" name="" id=""> <b>Teacher Time Table</b>
                    </td>
                    <td>
                        <input type="radio" name="" id=""> <b>Subject Time Table</b>
                    </td>
                    <td>
                        <input type="radio" name="" id=""> <b>Both</b>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row">
        <div class="col-md-9">
            <p><b>Timetable <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
        <div class="col-md-3">
            <div class="list-group">
                <button type="button" class="btn btn-square btn-outline-light">Import Time Table data</button>
            </div>
        </div>
...
<!-- Mirrored from travl.dexignlab.com/codeigniter/demo/page-empty by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Mar 2024 15:48:03 GMT -->
