            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        Department and Designation </div>
                </div>
...
<div class="content-body">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-4">Job Designation Type</div>
        <div class="col-md-4">Des-Des Mapping</div>
    </div>

    <div class="row mt-2">
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-3">Department <i class="fa fa-plus-circle" aria-hidden="true"></i></div>
                <div class="col-md-3"><span style="padding-right: 5px;"><input type="radio" name="" id="">
                        Active</span><span><input type="radio" name="" id="">
                        InActive</span></div>
                <div class="col-md-3"><i class="fas fa-search-location    "></i></div>
            </div>
            <div class="row tbl-bordered">
                <table class="table table-bordered table-inverse table-responsive">
                    ...
                    <tr>
                        <td>Accounts</td>
                        <td>Accounts</td>
                        <td>10:00:00 <i class="fas fa-clock    "></i></i></td>
                        <td>10:00:00 <i class="fas fa-clock    "></i></i></td>
