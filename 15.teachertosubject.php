...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <p><b>>Teacher To Subject <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
        <div class="col-md-3">
            <div class="list-group">
                <button type="button" class="btn btn-square btn-outline-light">Teacher Details</button>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="bg-light">
                    ...
                    <th>Action</th>
                    <th style="text-align: center;">Select<br /><input type="checkbox" name="" id=""></th>
                </tr>
            </table>
        </div>
