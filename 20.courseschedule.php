...
<div class="content-body">
        ...
        <div class="col-md-12">
            <table class="table">
                <tr>
                    ...
                    <td><input type="radio" name="" id=""> Weekly</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">Course Schedule</div>
        <div class="col-md-6">
            <button type="button" class="btn btn-square btn-outline-light">Generate Course Schedule</button>
        </div>
    </div>
    ...
    <div class="row tbl-bordered">
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                ...
                <tr>
                    <td>1</td>
                    <td>2018-2019-CBSE-E...</td>
                    <td>Pk1</td>
                    <td>CBSE - ...</td>
                    <td><select class="form-control " name="select" id="">
                            <option value="select">select</option>
                            <option value="select">select</option>
                            <option value="select">select</option>
                        </select></td>
                    ...
                    <td></td>
                    <td></td>
                    <td style=" text-align: center;"><i class="fa fa-trash" style="padding-left: 5px;" aria-hidden="true"></i></td>
                </tr>
                <tr>
                    <td>1</td>
                    <td>2018-2019-CBSE-E...</td>
