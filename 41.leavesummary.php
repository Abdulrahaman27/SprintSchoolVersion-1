...
<div class="content-body">
    ...
    <div class="row tbl-bordered">
        ...
        <div class="col-md-5">
            <b>HR Leave Request </b>
            <table class="table" style="border: 1px solid #ddd; padding: 20px;">
                <tr>
                    <td><b>From Date</b><input type="date" name="" class="form-control" id=""></td>
                    <td><b>To Date</b><input type="date" name="" class="form-control" id=""></td>
                </tr>
                <tr>
                    <td><b>Number of Days</b><input type="number" name="" class="form-control" id=""></td>
                    <td><b>Reason</b><input type="text" name="" class="form-control" id=""></td>
                </tr>
            </table>
        </div>

        <div class="col-md-12 tbl-bordered">
            <b>Leave Request History</b>
