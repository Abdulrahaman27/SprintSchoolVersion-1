...
<div class="content-body">
    ...
    <div class="row mx-auto tbl-bordered">
        <table class="table table-bordered table-inverse table-responsive">
            <tr class="bg-light">
                <th colspan="2" class="text-center" style="font-size: 12px;">Appraisal</th>
            </tr>
            <tr>
                <td>Last Appraisal Date:</td>
                <td>Appraisal Date:</td>
            </tr>
            <tr>
                <td>Current Salary(NIR):</td>
                <td>Revised Salary(NIR):</td>
            </tr>
            <tr>
                <td colspan="2">Appraisal By:</td>
            </tr>
            <tr>
                <td>Previous Goals<br /><span><input type="text" class="form-control"></span></td>
                <td>New Goals<br /><span><input type="text" class="form-control"></span></td>
            </tr>
            <tr>
                <td>Branch Rating's By Parents : </td>
                <td>Teachers Rating's By Admin : </td>
            </tr>
        </table>
    </div>
</div>
