...
<div class="content-body">
    ...
    <div class="row instituteregistration">
        <div class="col-md-4">
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">* Founder Name : </td>
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                        ...
                        <tr>
                            <td class="text-center">* Affliation : </td>
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                        ...
                        <tr>
                            <td class="text-center">* Any bannerimage? : </td>
                            <td><input type="radio" style="border: none;border-bottom: 1px solid #ddd;width: 100%;"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <select class="form-control" name="" id="">
                                        <option value="IND-School-Premium">IND-School-Premium</option>
                                        <option value="IND-School-Premium">IND-School-Premium</option>
                                        <option value="IND-School-Premium">IND-School-Premium</option>
                                    </select>
                                </div>
            ...
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 20%;" class="text-center">Document</td>
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="file" class="form-control bg-light" name="" id="" aria-describedby="helpId" placeholder="File description">
                                </div>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
            <div class="col-md-8">
                <table class="table table-striped table-inverse table-responsive">
                    <tbody>
                        <tr>
                            <td>Any Branch? : <input type="checkbox" name="" id=""></td>
                            <td>No. of Branch : <div class="form-group">
                                    <label for=""></label>
                                    <input type="number" class="form-control" name="" id="" aria-describedby="helpId" placeholder="5">
                                </div>
                            </td>
                        </tr>
                    </tbody>
    ...
    <div class="form-group mx-auto">
        <label for=""></label>
        <input type="submit" class="form-control" name="" id="" aria-describedby="helpId" value="Edit" style="width: auto; margin: 0 auto;">
    </div>
</div>
<!--**********************************
    Content body end
