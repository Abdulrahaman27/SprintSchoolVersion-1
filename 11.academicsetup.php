...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-8">
            <table class="table">
                <tr>
                    <td><b>Academic Year <i class="fa fa-plus-circle" aria-hidden="true"></i></b></td>
                    <td><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>Previous Year</td>
                    <td><i class="fa fa-arrow-circle-down" aria-hidden="true"></i> Current Year</td>
                    <td style="margin-left: 80px;">Next Year<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></td>
                    <td><i class="fas fa-search-location"></i></td>
                    <td style="border: 1px solid #ddd;">Curriculum Group <i class="fa fa-plus-circle" aria-hidden="true"></i> </td>
                </tr>
            </table>
        </div>
    </div>

    <div class="row academicsetup">
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="bg-light">
                    <th>Academic Year</th>
                    <th>Curriculum</th>
                    <th>Curriculum Group</th>
                    <th>Medium</th>
