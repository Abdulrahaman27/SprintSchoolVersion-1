...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2">
                <a href="24.mastersettings.php"><img src="public/assets/images/master.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Application Master</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="28.loaddata.php"><img src="public/assets/images/university_campus1.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Campus Configuration</h5>
                </a>
            </div>
        </div>
    </div>
