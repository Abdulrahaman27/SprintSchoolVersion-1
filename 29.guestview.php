...
<div class="content-body">
    ...
    <div class="row">
        <b>Website Banner Images</b>
        <hr>
    </div>
    <div class="row mx-auto mb-5">
        <div class="col-md-3 mx-auto">
            <span><input type="file" name="" id=""></span> Main Page Banner - 1<br />
            <img src="public/assets/images/gallery/hotel1.jpg" style="height: 200px;width: 300px;" alt="">
        </div>
        <div class="col-md-3 mx-auto">
            <span><input type="file" name="" id=""></span> Main Page Banner - 1<br />
            <img src="public/assets/images/gallery/hotel1.jpg" style="height: 200px;width: 300px;" alt="">
    ...
    <div class="row tbl-bordered">
        <div class="col-md-5">
            <b>Event Gallery Images <i class="fa fa-plus-circle" aria-hidden="true"></i></b>
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="text-center bg-light">
                    <th>*Event Related <br />Images</th>
                    <th>* Event Name</th>
                    <th>* Event Description</th>
                    <th>Action</th>
                </tr>
                <tr>
                    <td><span><i class="fa fa-upload" aria-hidden="true"></i></span>1044_13743</td>
        ...
        <div class="col-md-7 tbl-bordered">
            <b>Menu Item Details <span><i class="fa fa-plus-circle" aria-hidden="true"></i></span></b>
            <table class="table table-inverse table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <td>fa fa-a...<span><i class="fas fa-chess-rook    "></i></span></td>
                    <td>Admission</td>
                    <td>Interested Candidate...</td>
                    <td></td>
                    <td class="text-center"><span><i class="fa fa-envelope" aria-hidden="true"></i></span></td>
                </tr>
                <tr>
                    <td>
                        <select class=" form-control" name="select" id="">
