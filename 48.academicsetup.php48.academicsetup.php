...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2">
                <a href="11.academicsetup.php"><img src="public/assets/images/project_setup.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Academic Setup</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="21.finalmarks.php"><img src="public/assets/images/logbook.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Annual checks</h5>
                </a>
            </div>
        </div>
    </div>
