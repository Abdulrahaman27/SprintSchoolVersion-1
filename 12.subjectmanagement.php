...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <p><b>Subject Management <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
    </div>

    <div class="row subjectmanagement">
        <div class="col-md-12">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <label for=""></label>
                            <select class="form-control" name="Select" id="">
                                <option value="3rd Language">3rd Language</option>
                                <option value="select">Select</option>
                                <option value="select">Select</option>
                            </select>
                        </div>
