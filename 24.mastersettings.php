...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-3" style="border: 1px solid #ddd;padding-left: 20px;">
            <p>Master Config:
        ...
        <div class="col-md-7" style="margin-left: 20px;">
            <div class="row" style="padding-top:10px ;padding-bottom: 10px;">
                <div class="col-md-6" style="font-weight: bold;">Document Type <i class="fa fa-plus-circle" aria-hidden="true"></i></div>
                <div class="col-md-6" style="font-weight: bold;font-size: 10px;">
                    <span style="padding-right: 10px;"><input type="radio" name="" id=""> Active</span>
                    <span style="padding-right: 10px;"><input type="radio" name="" id="">
                        Inactive</span>
                </div>
            </div>
            <div class="row tbl-bordered">
                <table class="table table-bordered table-inverse table-responsive">
                    ...
                    <tr>
                        <td>1</td>
                        <td>fjbefcuififnif jhfhfbsdbhbbdfu</td>
                        <td><i class="fa fa-binoculars" aria-hidden="true"></i></td>
                    </tr>
                </table>
            </div>
