...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                <a href="32.donatefunds.php"><img src="public/assets/images/account1.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Account Activity</h5>
                </a>
            </div>
            <div class="col-md-3">
                <a href="36.shareddocuments.php"><img src="public/assets/images/activity_history.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Campus Activity</h5>
                </a>
            </div>
            <div class="col-md-3">
                <a href="38.achievement.php"><img src="public/assets/images/contact_details.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Personal Details</h5>
                </a>
            </div>
            <div class="col-md-3">
                <a href="45.attendance.php"><img src="public/assets/images/graduate.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Scholastics</h5>
                </a>
            </div>
        </div>
    </div>
