...
<div class="content-body">
        ...
        <div class="col-md-7">
            <table class="table">
                <tr>
                    ...
                    <td><br /><input type="button" class="form-control" value="Add Exam Details"></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6"><b>Final Marks</b></div>
        <div class="col-md-6">
            <input type="radio" name="" id="" checked> Summary&nbsp;&nbsp;
            <input type="radio" name="" id=""> Detailed
        </div>
    </div>
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="bg-light">
                    ...
                    <th>Roll No.</th>
                    <th>Max<br />Marks</th>
                    <th>Max<br />Obtained</th>
                    <th>Marks<br />%age</th>
                    <th>Grade</th>
                    <th>GPA</th>
                    <th>Can Be<br />Promoted <input type="checkbox" name="" id=""></th>
                    <th>Date <input type="checkbox" name="" id=""></th>
                    <th>Marks <input type="checkbox" name="" id=""></th>
                    <th>Remarks</th>
                </tr>
                <tr>
                    <td>Sixth</td>
                    ...
                    <td>B2</td>
                    <td>7.0</td>
                    <td style="text-align: center;"><input type="checkbox" checked name="" id=""></td>
