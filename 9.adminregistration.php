...
***********************************--> <!--**********************************
    Content body start
***********************************-->
<div class="content-body adminregistration">
    <!-- row -->
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for=""></label>
                <input type="submit" class="form-control" name="" id="" aria-describedby="helpId" value="Assign Branch Admin">
            </div>
        </div>
    </div>
    ...
    <div class="row pt-1">
        <div class="col-md-12">
            <p><b>Add new Branch Admin <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
    </div>
            ...
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">* ph Number : </td>
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
                        ...
                        <tr>
                            <td class="text-center">* Author No. : </td>
                            <td>
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="text" class="form-control" name="" id="" aria-describedby="helpId" placeholder="">
            ...
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-inverse table-bordered table-responsive" style="border: 1px solid #ddd;">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2">Pick Your Address</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="form-group">
            ...
            <div class="grey-color" style="border: 1px solid #ddd;border-radius: 5px;padding: 5px;">
                <table class="table table-striped table-inverse table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div style="border: 1px solid #ddd;width: 50%;height: 120px;"></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="row mt-5">
        <div class="col-md-12 mb-0">
            <p><b>Qualification details <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 mb-0">
            <p><b>>Experience (INR)details <i class="fa fa-plus-circle" aria-hidden="true"></i></b></p>
        </div>
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="bg-light">
                    <th>nstitution Name</th>
                    <th>Designation</th>
                    <th>From Date</th>
                    <th>Years of Exp.</th>
