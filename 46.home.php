...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2">
                <a href="1.statistics.php"><img src="public/assets/images/dashboard_layout.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Dashboard</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="1.statistics.php"><img src="public/assets/images/statistics.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Statistics</h5>
                </a>
            </div>
        </div>
    </div>
