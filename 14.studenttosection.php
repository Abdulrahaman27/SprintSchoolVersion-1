...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-4">
            <p><b>Student To Section</b></p>
        </div>
        <div class="col-md-4">
            <input type="radio" name="" id=""> <b>Assigned</b>
            <input type="radio" name="" id=""> <b>un-Assigned</b>
        </div>
    ...
    <div class="row tbl-bordered">
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                ...
                <tr>
                    <td>2018-19-CBSC-English</td>
                    <td>PK2</td>
                    <td> CBSE - PK21_011</td>
                    <td>Siddartha John</td>
                    <td>Good</td>
                    <td>
                        <select class="form-control " name="Select" id="">
                            <option value="select">Select</option>
