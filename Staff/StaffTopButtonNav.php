 ...
 <div class="row ms-2 mb-0">
    <div class="d-flex gap-2 align-items-center flex-wrap">
        ...
        <a href="http://localhost/PHP/SprintSchool/Staff_Discpline.php" class="btn btn-outline-dark">Discplin & Transfer</a>
        <a href="http://localhost/PHP/SprintSchool/" class="btn btn-outline-dark">Transportation</a>
        <a href="http://localhost/PHP/SprintSchool/" class="btn btn-outline-dark">Pay Structure</a>
        <a href="http://localhost/PHP/SprintSchool/" class="btn btn-outline-dark">Teaching Details</a>
        <a href="http://localhost/PHP/SprintSchool/" class="btn btn-outline-dark">Domitory</a>
    </div>
</div>
