...
<div class="content-body">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-2"><br /><input class="edris" type="file" name="" id=""></div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <br />
            <button type="button" class="btn btn-square btn-outline-light">Process Selected File</button>
        </div>
    </div>
    ...
    <div class="row mt-2 tbl-bordered">
        <table class="table table-bordered table-inverse table-responsive">
            <tr class="bg-light">
                <th>Processed Date</th>
                <th>Processed By</th>
                <th>Load File Name</th>
                <th>Total Processed</th>
                <th>Successful Records</th>
                <th>Failed Records</th>
                <th>Load Run Report</th>
            </tr>
            <tr>
                <td>April 30, 2019 4:38 PM</td>
                <td>Manish Gaddam</td>
                <td>SampleEntryLeadEx...</td>
                <td>5</td>
                <td>2</td>
                <td>3</td>
                <td>1044_1320109612131</td>
            </tr>
            <tr>
                <td>April 30, 2019 4:38 PM</td>
                <td>Manish Gaddam</td>
