...
<div class="content-body">
    <div class="row text-center" style="font-size: 12px;">
        <div class="col-md-5">
            <table class="table table-striped table-bordered table-inverse table-responsive" style="border: 1px solid black;">
                <tbody>
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="32.donatefunds.php">Donate
                                Funds</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="33.expenses.php">Expenses</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="34.salary.php">Salary</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="35.notificationconfig.php">Notifications Config</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="row tbl-bordered">
        <div class="col-md-12">
            <b>Add Expense(INR)</b><span style="padding-left: 10px;font-size: 20px;"><i class="fa fa-plus-circle" aria-hidden="true"></i></span>
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="bg-light">
                    <th>Expense Type</th>
                    <th>Tran Date</th>
                    <th>Tran<br />Amount</th>
                    <th>Claim Date</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <span style="padding-left: 3px;"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                    </td>
                </tr>
                <tr>
                    <td>Personal</td>
