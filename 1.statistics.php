...
<div class="content-body">
    <div class="row text-center" style="font-size: 12px;">
        <div class=" col-md-12">
            <table class="table table-striped table-bordered table-responsive" style="border: 1px solid black;">
                <tr>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="1.statistics.php">User
                            Summary</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="2.vehiclesummary.php">Vehicle Summary</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="3.dormitorysummary.php">Dormitory Summary</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="4.topperssummary.php">Toppers Summary</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="5.visitorsummary.php">Visitor Summary</a></td>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="6.teachingplansummary.php">Teaching Plan Summary</a></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row statistics">
        <div class="col-md-12">
            <table class="table table-bordered table-inverse table-responsive">
                ...
                <tr class="bg-light">
                    <td colspan="4" class="text-center">Total User Summary</td>
                    <td>186</td>
                    <td>62</td>
                    <td>129</td>
                    <td>125</td>
                ...
                <tr>
                    <td>Lakeland Middle Branch</td>
                    <td>2018-19-CBSE-English_GEN</td>
                    <td>First</td>
                    <td>CBSE_1A</td>
                    <td>12</td>
                    <td>4</td>
