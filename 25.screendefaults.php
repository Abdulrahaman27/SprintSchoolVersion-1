...
<div class="content-body">
    <div class="row" style="font-size: 10px;">
        <div class="col-md-7">
            <table class="table table-bordered table-inverse table-responsive" style="border:1px solid black">
                <tr>
                    <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="24.mastersettings.php">Master Settings</a></td>
                    <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="25.screendefaults.php">Screen Defaults</a></td>
                    <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="26.buildingmanagement.php">Building Management</a></td>
                    <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="27.department&designation.php">Department & Designation</a></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row tbl-bordered">
        <div class="col-md-7">
            <div class="row">
                <p style="font-weight: bold;">Screen Left Grid Defaults</p>
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control " name="select" id="">
                            <option value="select" selected>Student Name</option>
                    ...
                    <td>
                        <select class="form-control " name="select" id="">
                            <option value="select" selected>Class Name</option>
                            <option value="select">select</option>
                            <option value="select">select</option>
                        </select>
                    </td>
        ...
        <div class="col-md-5">
            <div class="row">
                <div class="col-md-5">
                    <p style="font-weight: bold;">Landing Page Defaults
                        <select class="form-control " name="select" id="">
                            <option value="select" selected>Weight Name</option>
                            <option value="select">select</option>
                            <option value="select">select</option>
                        </select>
                    </p>
            ...
            <div class="row tbl-bordered">
                <div class="col-md-12">
                    <table class="table table-bordered table-inverse table-responsive">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Outstanding Fee Payments</td>
                            <td class="text-center"><input checked type="radio" name="" id=""></td>
                        </tr>
                        <tr>
                            <td>1</td>
            ...
            <div class="row tbl-bordered">
                <div class="col-md-12">
                    <p style="font-weight: bold;">Client Options</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-inverse table-responsive">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Mail</td>
                            <td class="text-center"><input type="checkbox" checked name="" id=""></td>
                            <td class="text-center"><input type="checkbox" checked name="" id=""></td>
                            <td class="text-center"><input type="checkbox" checked name="" id=""></td>
                            <td class="text-center"><input type="checkbox" checked name="" id=""></td>
                        </tr>
            ...
            <div class="col-md-6">
                <div class="mx-auto" style="text-align: center;">
                    <button type="button" class="btn btn-square btn-outline-light">Process Selected
                        File</button>
                </div>
            </div>
        </div>
