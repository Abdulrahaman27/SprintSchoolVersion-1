    ...
    <div class="row text-center" style="font-size: 12px;">
        <div class="col-md-3">
            <table class="table table-striped table-bordered table-responsive" style="border: 1px solid black;">
                <tbody>
                    <tr>
                        <td style="border: 1px solid black;" class="pt-1 pb-1"><a href="36.shareddocuments.php">Shared Documents</a></td>
                        <td style="border: 1px solid black;" class=" pt-1 pb-1"><a href="37.assignedtask.php">Assigned Task</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
