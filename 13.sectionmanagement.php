...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <p>Section Management <i class="fa fa-plus-circle" aria-hidden="true"></i></p>
        ...
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-inverse table-responsive">
                ...
                <tr>
                    ...
                    <th>* Curriculum Code</th>
                    <th>* Class</th>
                    <th>* Max<br /> Strength</th>
                    <th>Primary Class<br />Teacher</th>
                    <th>Secondary Class Teacher</th>
                    <th>Hall Name</th>
                    <th>Notes</th>
                ...
                <tr>
                    <td>CBSC-10c</td>
                    <td>2018-19-CBSE-English-GEN</td>
                    <td>Ninth</td>
                    <td>45</td>
                    <td>Mamata Sharma</td>
                    <td>Mamata Sharma</td>
                    ...
                    <td>2</td>
                    <td>45</td>
                    <td><i class="fas fa-edit"></i><i class="fa fa-trash" style="padding-left: 5px;" aria-hidden="true"></i></td>
                </tr>
                <tr>
                    <td>CBSC-10c</td>
                    <td>2018-19-CBSE-English-GEN</td>
