        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-inverse table-responsive">
                <tr class="text-center bg-light">
                    <th>Receive SMS</th>
                    <th style="width: 20%;">Receive Internal Email</th>
                    <th style="width: 20%;">Receive Push Notification</th>
                    <th style="width: 20%;">Receive External Email</th>
    ...
    <div class="row">
        <div class="col-md-3 mx-auto">
            <div class="">
                ...
                <button type="button" class="btn btn-square btn-outline-light">Reset</button>
            </div>
        </div>
    </div>
