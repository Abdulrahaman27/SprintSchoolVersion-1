...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2">
                <a href="7.instituteregistration.php"><img src="public/assets/images/admission.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">Institute Registration</h5>
                </a>
            </div>
            <div class="col-md-2">
                <a href="9.adminregistration.php"><img src="public/assets/images/user_menu_female.svg" alt=""><br />
                    <h5 class="text-center" style="color:#848484">User Registration</h5>
                </a>
            </div>
        </div>
    </div>
